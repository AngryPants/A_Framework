...
void RenderHelper::RenderText(Mesh& mesh, const TextureList& textureList, const string& text, Color color, bool lightEnabled) {
	switch (currentShader) {
		case SHADERS::PHONG:
			PhongShader::RenderText(mesh, textureList, text, color, lightEnabled, phongUniforms);
			break;
	}
}