...
Application::Application() {
	...
	m_window_width = LuaInterface::GetInstance().getIntValue("width");
	m_window_width = LuaInterface::GetInstance().getIntValue("height");

	LuaInterface::GetInstance().Run();
	LuaInterface::GetInstance().saveFloatValue("Player1", 200.10, true);
	LuaInterface::GetInstance().saveIntValue("Player2", 100);
}
